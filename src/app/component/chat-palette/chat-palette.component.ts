...
・ダイスボットコマンド
　チャットからダイスボットコマンドを送信することにより、ダイスロールや表の参照が可能です。実際のコマンドはゲームシステムごとのダイスボットのヘルプを参照してください。またダイスボット表機能によりをダイスボットコマンドを拡張することができます。
...
　チャットパレットのいずれかの行に上記の例のように記述されていればそのキャラクターから送信するコマンドやチャットメッセージ中の {今の天気} が 雨 に置き換わります。
